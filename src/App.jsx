...
function App() {
  ...
  const paragraphs = [
    "안녕하세요, 저는 이유나입니다. 저는 프론트엔드는 단순한 화면 구현이 아니라, 기술이 사용자에게 제대로 전달되도록 만드는 핵심 역할이라고 생각합니다. 프론트엔드가 부족하면 아무리 뛰어난 기술도 외면받는 죽은 기술이 될 수 있기에, 저는 사용자 경험을 깊이 고민하며, 기술이 제대로 쓰이도록 만드는 개발자가 되고자 합니다."
  ];
